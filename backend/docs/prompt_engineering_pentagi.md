...
- For engagement-level boundaries, start from the reusable [scope-of-work pentest prompt template](../../examples/prompts/scope_of_work_pentest.md) and adapt the allowed targets, canonical out-of-scope targets, stop conditions, and evidence expectations before the flow starts.
